...
namespace Vista.Componentes
{
    ...
    {
        public void lineBorder(Panel panel, int red = 196, int green = 209, int blue = 230, int width = 1)
        {
        ...
        public void rightLine(Panel panel, int red = 196, int green = 209, int blue = 230, int width = 1)
        {
            Graphics line = panel.CreateGraphics();
        ...
        public void leftLine(Panel panel, int red = 196, int green = 209, int blue = 230, int width = 1)
        {
            Graphics line = panel.CreateGraphics();
        ...
        public void topLine(Panel panel, int red = 196, int green = 209, int blue = 230, int width = 1)
        {
            Graphics line = panel.CreateGraphics();
        ...
        public void bottomLine(Panel panel, int red = 196, int green = 209, int blue = 230, int width = 1)
        {
            Graphics line = panel.CreateGraphics();
